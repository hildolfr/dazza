 ...
 */
export async function getCanonicalUsername(bot, username) {
 ...
 */
export function getCanonicalCacheSize() {
 ...
 */
export async function normalizeUsernameForDb(bot, username) {
 ...
 */
export function usernamesMatch(username1, username2) {
 ...
 */
export async function batchNormalizeUsernames(bot, usernames) {
